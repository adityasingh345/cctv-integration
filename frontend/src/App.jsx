...
export default function App() {
  ...
  useEffect(() => {
    ...
    loadCams();
    const t = setInterval(loadCams, 15000);   // refresh status every 15s
  ...
  return (
    <div className="app">
      ...
      <div className="grid">
        ...
        <section className="panel detections-panel">
          <h2>Vehicle Analytics (live)</h2>
          <VehicleStats />
        </section>
        <section className="panel plates-panel">
          <h2>Detected Plates</h2>
          <PlatesPanel onTrack={setTrackedPlate} />
        </section>
      </div>
    </div>
  );
